...
<html lang="en">
  <head>
    ...
    <title>ES WEB DEV 2021</title>

    <!-- vendor css -->
    <link href="{{asset('style/lib/font-awesome/css/font-awesome.css')}}" rel="stylesheet">
    <link href="{{asset('style/lib/Ionicons/css/ionicons.css')}}" rel="stylesheet">
    <link href="{{asset('style/lib/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet">
    <link href="{{asset('style/lib/jquery-switchbutton/jquery.switchButton.css')}}" rel="stylesheet">
    <link href="{{asset('style/lib/rickshaw/rickshaw.min.css')}}" rel="stylesheet">
    <link href="{{asset('style/lib/chartist/chartist.css')}}" rel="stylesheet">

    <!-- Bracket CSS -->
    <link rel="stylesheet" href="{{asset('style/css/bracket.css')}}">
  </head>

  <body>

    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href="{{url('dashboard')}}"><span>[</span>Nazmul_IT<span>]</span></a></div>
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down">{{Auth::user()->name ?? 'N/A'}}</span>
              <img src="{{asset('style/img/Nazmul.jpg')}}" class="wd-32 rounded-circle" alt="">
                ...
                <li>
                  <a class="dropdown-item" href="{{route('logout')}}"
                    onclick="event.preventDefault();
                      ...
                      <i class="icon ion-power"></i> {{_('Sign Out')}}
                  </a>
    ...
    <script src="{{asset('style/lib/jquery/jquery.js')}}"></script>
    <script src="{{asset('style/lib/popper.js/popper.js')}}"></script>
    <script src="{{asset('style/lib/bootstrap/bootstrap.js')}}"></script>
    <script src="{{asset('style/lib/perfect-scrollbar/js/perfect-scrollbar.jquery.js')}}"></script>
    <script src="{{asset('style/lib/moment/moment.js')}}"></script>
    <script src="{{asset('style/lib/jquery-ui/jquery-ui.js')}}"></script>
    <script src="{{asset('style/lib/jquery-switchbutton/jquery.switchButton.js')}}"></script>
    <script src="{{asset('style/lib/peity/jquery.peity.js')}}"></script>
    <script src="{{asset('style/lib/chartist/chartist.js')}}"></script>
