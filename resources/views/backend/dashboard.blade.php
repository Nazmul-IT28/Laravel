...
<div class="br-mainpanel">
    <div class="pd-30">
      ...
      <p class="mg-b-0">Wellcome To Bracket Dashboard</p>
    </div><!-- d-flex -->
    ...
    <footer class="br-footer bg-dark">
      <div class="footer-left">
        <div class="mg-b-2 tx-white tx-12">Copyright &copy; 2021. Bracket. All Rights Reserved By Nazmul Islam</div>
      </div>
      <div class="footer-right d-flex align-items-center">
        <span class="tx-uppercase mg-r-10 tx-info">Share:</span>
        <a target="_blank" class="pd-x-5" href="https://www.facebook.com/Tahsan.98892615"><i class="fa fa-facebook tx-20 tx-info"></i></a>
        <a target="_blank" class="pd-x-5" href="https://www.facebook.com/Tahsan.98892615"><i class="fa fa-youtube tx-20 tx-info"></i></a>
        <a target="_blank" class="pd-x-5" href="https://www.facebook.com/Tahsan.98892615"><i class="fa fa-linkedin tx-20 tx-info"></i></a>
      </div>
    </footer>
  </div><!-- br-mainpanel -->
@endsection